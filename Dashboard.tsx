...
import { User, Tournament, TournamentType } from './types';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <main>
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-3xl font-bold">Game Rooms</h2>
                    ...
                    <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-4 sm:p-6 shadow-2xl shadow-cyan-500/10">
                        {tournaments.length > 0 ? (
                                    ...
                                    <div key={t.id} className="relative group">
                                        <a href={`#/tournaments/${t.id}`} className="block bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-lg p-4 transition-colors h-full">
                                            <div className="flex justify-between items-start">
                                                ...
                                                <span className={`text-xs font-semibold px-2 py-1 rounded-full text-white bg-yellow-500`}>
                                                    Open
                                                </span>
                                            </div>
                                            <p className="text-sm text-gray-300 mt-2">{t.players.length} players joined</p>
                                        </a>
                            ...
                            <p className="text-center text-gray-400 py-8">No game rooms found. Why not create one?</p>
                        )}
                    </div>
                </main>
            </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
                    <div className="bg-gray-800 border border-gray-700 rounded-lg shadow-xl w-full max-w-md text-white p-6">
                        ...
                        <form onSubmit={handleCreateTournament} className="space-y-4">
                             <div>
                                <label className="block mb-1 font-semibold" htmlFor="tournamentName">Room Name</label>
                                <input
                                    ...
                                    placeholder="e.g., Weekend Chess Club" required autoFocus
                                />
                            </div>
                             <div>
